...
class TestDAOTwitterLimitNotice(unittest.TestCase):
    ...
    def test_update_new_result(self):
        ...
        dao_twitter_counter = CollectionClassifierController(self.client, self.database_name)

        dao_twitter_counter.get_collection_by_tags(["PP", "PP", "Ciudadanos", "#labarbacoa"])
